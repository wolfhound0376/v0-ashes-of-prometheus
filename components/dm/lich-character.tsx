...
interface LichCharacterProps {
  state: 'idle' | 'speaking' | 'thinking' | 'casting'
  currentDialogue: string
}

export function LichCharacter({ state, currentDialogue }: LichCharacterProps) {
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      {state === 'speaking' && currentDialogue && (
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 max-w-md animate-fade-in">
