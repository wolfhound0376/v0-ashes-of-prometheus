      ...
      <FantasyPanel className="flex-1 min-h-0 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="flex">
            ...
            <div className="w-24 border-l border-[#3d3428]/40 p-3 flex flex-col gap-4">
              <ActionCounter label="Action" value={resources.action} />
              <ActionCounter label="Bonus Action" value={resources.bonusAction} />
              <ActionCounter label="Reaction" value={resources.reaction} />
            </div>
          </div>
        </div>
...
function ActionCounter({ label, value }: { label: string; value: number }) {
  return (
    <div className="text-center">
      ...
      <div
        className={cn(
          ...
          value > 0 ? "text-[#7aa8c8] drop-shadow-[0_0_8px_rgba(100,150,200,0.5)]" : "text-stone-600"
        )}
      >
        {value}
      </div>
