...
test("hp_max is never written", () => {
  // The reset restores what the fight SPENT. It does not decide how tough
  // anything is.
  assert.ok(!/hp_max:\s/.test(code), "the reset is writing hp_max - it must only restore, never redefine")
})
