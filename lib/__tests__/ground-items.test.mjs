...
execFileSync(process.env.ESBUILD || "esbuild",
  ...
  { stdio: "inherit" })
const { withinReach, interactionCost, normaliseGroundItems, describePile } = await import(pathToFileURL(bundle).href)
...
// COST, SRD 5.1 "Interacting with Objects Around You".
{
