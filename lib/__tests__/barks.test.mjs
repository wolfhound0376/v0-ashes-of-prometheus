...
const RECORDED = new Set(["drow", "drow elite warrior", "drow priestess of lolth", "prince derendil", "jimjar"])
...
test("an unrecorded creature stays a printed line", () => {
  ...
  // plain drow's recordings and say something it never said. Since the
  // 2026-09-26 re-cut it has recordings of its own: its file, never drow_N.
  assert.equal(barkAudioFor("Drow Elite Warrior", BARKS["drow elite warrior"][0]), "barks/drow-elite-warrior_0")
})
