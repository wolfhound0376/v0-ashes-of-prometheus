...
export const actionsData = [
  ...
  { id: "cast-reaction-spell", name: "Cast Reaction Spell", description: "Cast a spell like Shield or Counterspell.", icon: "shield-plus", iconUrl: "/icons/abilities/shield.png", type: "reaction" },
