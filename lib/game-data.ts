...
export const actionsData = [
  // Standard Actions (Green) - Using built-in fantasy icons
  { id: "attack", name: "Attack", description: "Make a melee or ranged attack.", icon: "sword", iconUrl: null, type: "action" },
  { id: "cast-spell", name: "Cast a Spell", description: "Cast a spell with a casting time of 1 action.", icon: "sparkles", iconUrl: null, type: "action" },
  ...
  { id: "cunning-action", name: "Cunning Action", description: "Dash, Disengage, or Hide as a bonus action. (Rogue)", icon: "footprints", iconUrl: null, type: "bonus", hasSubmenu: true },
