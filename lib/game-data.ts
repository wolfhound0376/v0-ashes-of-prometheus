...
// D&D 5E Starting Equipment by Class (from Player's Handbook)
export const startingEquipment: Record<string, {
  equipment: Array<{ slot: string; name: string; icon: string }>
  inventory: Array<{ name: string; quantity: number; icon: string }>
  gold: number
}> = {
  "Barbarian": {
    equipment: [
      { slot: "mainHand", name: "Greataxe", icon: "axe" },
      { slot: "torso", name: "Hide Armor", icon: "armor" },
    ],
    inventory: [
      { name: "Handaxe", quantity: 2, icon: "axe" },
      { name: "Javelin", quantity: 4, icon: "spear" },
      { name: "Explorer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Bard": {
    equipment: [
      { slot: "mainHand", name: "Rapier", icon: "sword" },
      { slot: "torso", name: "Leather Armor", icon: "armor" },
    ],
    inventory: [
      { name: "Lute", quantity: 1, icon: "instrument" },
      { name: "Dagger", quantity: 1, icon: "dagger" },
      { name: "Diplomat's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 15,
  },
  "Cleric": {
    equipment: [
      { slot: "mainHand", name: "Mace", icon: "mace" },
      { slot: "offHand", name: "Shield", icon: "shield" },
      { slot: "torso", name: "Scale Mail", icon: "armor" },
      { slot: "neck", name: "Holy Symbol", icon: "amulet" },
    ],
    inventory: [
      { name: "Light Crossbow", quantity: 1, icon: "crossbow" },
      { name: "Crossbow Bolts", quantity: 20, icon: "arrow" },
      { name: "Priest's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 15,
  },
  "Druid": {
    equipment: [
      { slot: "mainHand", name: "Wooden Shield", icon: "shield" },
      { slot: "torso", name: "Leather Armor", icon: "armor" },
      { slot: "neck", name: "Druidic Focus", icon: "amulet" },
    ],
    inventory: [
      { name: "Scimitar", quantity: 1, icon: "sword" },
      { name: "Explorer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Fighter": {
    equipment: [
      { slot: "mainHand", name: "Longsword", icon: "sword" },
      { slot: "offHand", name: "Shield", icon: "shield" },
      { slot: "torso", name: "Chain Mail", icon: "armor" },
    ],
    inventory: [
      { name: "Light Crossbow", quantity: 1, icon: "crossbow" },
      { name: "Crossbow Bolts", quantity: 20, icon: "arrow" },
      { name: "Dungeoneer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Monk": {
    equipment: [
      { slot: "mainHand", name: "Shortsword", icon: "sword" },
      { slot: "torso", name: "Simple Clothes", icon: "robe" },
    ],
    inventory: [
      { name: "Dart", quantity: 10, icon: "dart" },
      { name: "Explorer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 5,
  },
  "Paladin": {
    ...
    inventory: [
      { name: "Javelin", quantity: 5, icon: "spear" },
      { name: "Priest's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Ranger": {
    equipment: [
      { slot: "mainHand", name: "Longbow", icon: "bow" },
      { slot: "torso", name: "Scale Mail", icon: "armor" },
    ],
    inventory: [
      { name: "Arrows", quantity: 20, icon: "arrow" },
      { name: "Shortsword", quantity: 2, icon: "sword" },
      { name: "Explorer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Rogue": {
    ...
    inventory: [
      { name: "Shortbow", quantity: 1, icon: "bow" },
      { name: "Arrows", quantity: 20, icon: "arrow" },
      { name: "Dagger", quantity: 2, icon: "dagger" },
      { name: "Thieves' Tools", quantity: 1, icon: "tools" },
      { name: "Burglar's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Sorcerer": {
    equipment: [
      { slot: "mainHand", name: "Dagger", icon: "dagger" },
      { slot: "neck", name: "Arcane Focus", icon: "amulet" },
    ],
    inventory: [
      { name: "Light Crossbow", quantity: 1, icon: "crossbow" },
      { name: "Crossbow Bolts", quantity: 20, icon: "arrow" },
      { name: "Component Pouch", quantity: 1, icon: "pouch" },
      { name: "Dungeoneer's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Warlock": {
    equipment: [
      { slot: "mainHand", name: "Light Crossbow", icon: "crossbow" },
      { slot: "torso", name: "Leather Armor", icon: "armor" },
      { slot: "neck", name: "Arcane Focus", icon: "amulet" },
    ],
    inventory: [
      { name: "Crossbow Bolts", quantity: 20, icon: "arrow" },
      { name: "Dagger", quantity: 2, icon: "dagger" },
      { name: "Scholar's Pack", quantity: 1, icon: "backpack" },
    ],
    gold: 10,
  },
  "Wizard": {
    equipment: [
      { slot: "mainHand", name: "Quarterstaff", icon: "staff" },
      { slot: "neck", name: "Arcane Focus", icon: "amulet" },
    ],
    inventory: [
      { name: "Spellbook", quantity: 1, icon: "book" },
      { name: "Component Pouch", quantity: 1, icon: "pouch" },
      { name: "Scholar's Pack", quantity: 1, icon: "backpack" },
      { name: "Dagger", quantity: 1, icon: "dagger" },
    ],
...
export function getStartingEquipment(className: string) {
  return startingEquipment[className] || startingEquipment["Fighter"]
}
