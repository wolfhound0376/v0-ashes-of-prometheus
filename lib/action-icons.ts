...
const SPELL_SLUGS = new Set([
  ...
  "blink", "burning-hands", "counterspell", "create-or-destroy-water", "cure-wounds",
  "dash", "detect-magic", "disengage", "disguise-self", "dispel-magic", "divine-favor",
  ...
  "levitate", "longstrider", "magic-missile", "magic-weapon", "mirror-image", "misty-step",
  "moonbeam", "prayer-of-healing", "protection-from-evil-and-good", "purify-food-and-drink",
  "ray-of-sickness", "resist-energy", "sacred-flame", "sacred-weapon", "sanctuary",
  "searing-smite", "shatter", "shield", "silence", "silent-image", "sleep", "sneak-attack",
  "spirit-guardians", "spiritual-weapon", "suggestion", "tashas-hideous-laughter",
