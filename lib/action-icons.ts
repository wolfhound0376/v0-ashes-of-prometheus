...
const SPELL_SLUGS = new Set([
  ...
  "bardic-inspiration", "beast-bond", "beautyberry", "bless", "blindness-deafness",
  "blink", "burning-hands", "chill-touch", "counterspell", "create-or-destroy-water", "cure-wounds",
  "dash", "detect-magic", "disengage", "disguise-self", "dispel-magic", "dissonant-whispers", "divine-favor",
  "earth-tremor", "eldritch-blast", "enlarge-reduce", "enrage", "ensnaring-strike",
  "entangle", "expeditious-retreat", "fade-away", "faerie-fire", "false-life", "feather-fall",
  "fireball", "flame-strike", "fog-cloud", "frostbite", "goodberry", "grease", "greater-invisibility",
  "guidance", "guiding-bolt", "gust-of-wind", "hail-of-thorns", "healing-spirit",
  "healing-word", "heat-metal", "hellish-rebuke", "hex", "hide", "hold-person", "hunters-mark",
  "inflict-wounds", "invisibility", "jump", "leomunds-tiny-hut", "lesser-restoration",
  "levitate", "longstrider", "magic-missile", "magic-weapon", "minor-illusion", "mirror-image", "misty-step",
  "moonbeam", "prayer-of-healing", "protection-from-evil-and-good", "purify-food-and-drink",
  "ray-of-frost", "ray-of-sickness", "resist-energy", "sacred-flame", "sacred-weapon", "sanctuary",
  "searing-smite", "shatter", "shield", "shocking-grasp", "silence", "silent-image", "sleep", "sneak-attack",
  "spirit-guardians", "spiritual-weapon", "suggestion", "tashas-hideous-laughter", "thaumaturgy", "toll-the-dead",
  "thorn-whip", "thunderwave", "vicious-mockery", "warding-bond", "water-breathing",
  "web", "witch-bolt", "wrathful-smite", "zephyr-strike",
])
